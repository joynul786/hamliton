            ...
            <Grid container>
              <Grid item sm={12} lg={7}>
                ...
                <Typography variant="body1" mt={2}>
                  Hamilton provides a range of information and communications
                  technology (ICT) products and solutions that enable companies
                  to optimize their workforce productivity, decrease operational
                  expenses, and enhance enterprise security.
                </Typography>
              </Grid>
            </Grid>
          </Box>
