          ...
          <Grid container spacing={{ xs: 1, md: 3 }} p={{ xs: 2, md: 3 }}>
            <Grid item xs={12} md={7}>
              <Box pl={{ xs: 2, md: 5 }}>
                ...
                <br />
                <Typography
                  className="ServicesIndustry"
                >
                  Hamilton for the Financial Services Industry
                </Typography>

                <Typography variant="body2">
                  In the past few decades, digitization has transformed the financial
                  services sector with the emergence of online banking, neobanks,
                  mobile wallets, commission-free trading apps, and BNPL apps. These
                  technologies have made financial services accessible to more people
                  worldwide. Moreover, blockchain technologies and digital ledgers have
                  enabled new developments in cryptocurrencies, digital coins, and NFTs.
                </Typography>
              </Box>
            </Grid>
          </Grid>
          ...
          <Grid container spacing={{ xs: 1, md: 3 }} p={{ xs: 2, md: 3 }}>
            <Grid item xs={12} md={7}>
              <Box pl={{ xs: 2, md: 5 }}>
                ...
                <Typography variant="body2">
                  The hospitality industry is constantly evolving, and advancements in
                  connectivity technology have played a key role in its growth. Wi-Fi,
                  SMS, mobile services, and IoT have enabled hotels, restaurants,
                  travel agencies, and entertainment companies to optimize operations,
                  enhance customer engagement, and strengthen customer loyalty through
