...
import HeaderImage from "assets/img/static/bg/customer-stories-3.png";
...
const CustomerStoriesM1mvne = () => {
  ...
  return (
    <>
      <CustomerStoriesDetailsHeader title="M1MVNE & MVNO" image={HeaderImage} />
...
export default CustomerStoriesM1mvne;
