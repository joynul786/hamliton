      ...
      <Box py={5} color="black.main">
        <Container maxWidth="xl">
          <Box textAlign="center" py={5}>
            <Title title="Hamilton’s Products and Solutions" fontSize={36} />
          </Box>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={5}>
              <Box pt={5}>
                <Title
                  fontSize={36}
                  title="Mobile Services <br />for Universities"
                />
              </Box>
            </Grid>
          ...
          <Grid container spacing={3} mt={5}>
            ...
            >
              <Box pb={{ md: 5 }}>
                <Title
                  fontSize={36}
                  title="Global Cellular and Wi-Fi Connectivity"
                />
              </Box>
            </Grid>
          </Grid>
