      ...
      <Box py={5} color="black.main">
        <Container>
          <Box maxWidth={700} margin="auto" textAlign="center">
            <SectionHeading title="The Most Flexible MVNO Solution" />
            <Typography variant="body1" py={5}>
              Launching a full MVNO with Hamilton gives businesses full control
              over their services, including managing their own core network
              elements, applications, rating and billing, customer care, and
              sales and marketing. All while leaving the radio access to Mobile
              Operators.
            </Typography>
          </Box>
          <Box
...
export default FullMvnoSolutions;
