...
import HeaderImage from "assets/img/static/bg/customer-stories-5.png";
...
const CustomerStoriesSmartCity = () => {
  ...
  return (
    <>
      <CustomerStoriesDetailsHeader
        title="Smart City KyivInternet of Things"
        image={HeaderImage}
      />
...
export default CustomerStoriesSmartCity;
